...
function ProgressIcon() {
  return (
    <div className='progress-icon flex-center'>
...
function ProgressNumber({progress}) {
  return (
    <div className='progress-number flex-center'>
...
function ProgressSection({progress}) {
  return (
    <div className='progress-section flex-container'>
      <ProgressIcon/>
...
function CreateTextButton() {
  return (
    <div className='create-text-btn flex-center'>
      <p>Create new task</p>
    </div>
  )
}
...
function CreateNewTaskBtn() {
  return (
    <div className='create-container flex-container'>
      <CreateButton/>
      <CreateTextButton/>
    </div>
  )
...
function App() {
  return (
    <div className="main-section flex-container">
      <HeaderSection/>
      <BodySection/>
    </div>
  )
